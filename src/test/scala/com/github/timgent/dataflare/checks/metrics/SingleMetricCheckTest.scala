...
import com.github.timgent.dataflare.checks.{CheckStatus, RawCheckResult} // DO NOT DELETE - required for tests
import com.github.timgent.dataflare.metrics.MetricDescriptor.SumValuesMetric // DO NOT DELETE - required for tests
import com.github.timgent.dataflare.metrics.MetricValue.{DoubleMetric, LongMetric} // DO NOT DELETE - required for tests
